...
class MoneyTransferTestWithBugs {
    ...
    void shouldTransferMoneyBetweenOwnCards() {
        ...
        int secondCardBalanceAfter = dashboard.getCardBalance(secondCard);
    ...
    void shouldNotAllowTransferMoreThanBalance() {
        ...
        assertEquals(dashboard.getCardBalance(secondCard), secondCardBalanceAfter);
    }
